...
public class Graph<T> {
	...
	public int addNode(T node) {
		 ...
		 * grafo o no cabe
		 * 
		 * @param node el nodo que se desea a�adir
		 * @return int 0 si el nodo es a�adido correctamente; -1 si existe el nodo; -2
	...
	public int getNode(T node) {
		/**
		 * M�todo que devuelve la posici�n de un nodo en el vector nodes
		 * 
		 * @param node el nodo a buscar
		 * @return int la posici�n del nodo a buscar, devuelve -1 en caso de que no se
	...
	public int removeNode(T node) {
		/**
		 * M�todo que elimina un nodo del grafo
		 *
	...
	public boolean existNode(T node) {
		/**
		 * M�todo que comprueba si el nodo pasado como par�metro existe en grafo
		 *
	...
	public boolean existEdge(T source, T target) {
		/**
		 * M�todo que comprueba si existe arista entre dos nodos
		 *
	...
	public int addEdge(T source, T target, double weight) {
		/**
		 * M�todo que a�ade una arista entre dos nodos
		 *
		 * @param source el nodo origen
		 * @param target el nodo destino
	...
	public int removeEdge(T source, T target) {
		/**
		 * M�todo que elimina una arista del grafo en caso de que esta exista
		 *
		 * @param source el nodo origen
		 * @param target el nodo destino
	...
	private double[] initializeDijkstraD(T node) {
		/**
		 * M�todo auxiliar que genera un vector D inicializado para el Algoritmo de
		 * Dijkstra
		 *
	...
	private T[] initializeDijkstraP(T node) {
		/**
		 * M�todo auxiliar que genera un vector P inicializado para el Algoritmo de
		 * Dijkstra
		 *
	...
	private T[][] initializeFloydP() {
		/**
		 * M�todo que inicializa la matriz de caminos P para el Algoritmo de Floyd
		 *
	...
	private double[][] initializeFloydA() {
		/**
		 * M�todo que inicializa la matriz de pesos A para el Algoritmo de Floyd
		 *
	...
	public double minCostPath(T origen, T destino) {
		 ...
		 * obtener el valor por alguna raz�n, devuelve �1 (OJO que es distinto de
		 * infinito)
		 **/
	...
	public String path(T origen, T destino) {
		/**
		 * Indica el camino entre los nodos que se le pasan como par�metros de esta
		 * forma:
		 *
	...
	private void pathFloydIntermedios(T origen, T destino) {
		/**
		 * M�todo auxiliar que muestra el camino m�nimo entre 2 nodos usando las
	...
	private void recursivoProfundidad(T source, boolean[] visited) {
		 ...
		 * nuevo nodo.
		 *
		 * Adem�s, imprime el recorrido seguido en cadenaDFS
		 *
		 * @param source  el nodo origen
