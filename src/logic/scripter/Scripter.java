...
public class Scripter {
	...
	public static void main(String[] args) {
		...
		// List<Metric> metrics = FileParser.parseMetrics("./executionResults/23 Feb
		// 2021 14-44-58 GMT.csv");

		/*
		 * GraphCommand box = new BoxPlot("autoBoxPlotTest.pdf", metrics);
		 * 
		 * List<GraphCommand> graphs = new ArrayList<GraphCommand>(); graphs.add(box);
		 * 
		 * String script = Scripter.createScript(metrics, graphs);
		 * System.out.println(script); RScriptRunner.runRScript(script);
		 */
	}
